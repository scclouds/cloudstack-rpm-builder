...
if [ $show_help = true ]; then
    ...
    cat << USAGE
Usage: docker run ... scclouds/cloudstack-rpm-builder [DOCKER_OPTIONS] ... [PACKAGING_OPTIONS]...
...
Examples:
   docker run ... scclouds/cloudstack-rpm-builder [PACKAGING_OPTIONS] ...
   docker run ... scclouds/cloudstack-rpm-builder --git-remote https://path.to.repo/cloudstack.git --git-ref foo-branch [PACKAGING_OPTIONS] ...
